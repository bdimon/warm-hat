...
const HeaderSecond = () => {
  ...
  return (
    <header className={cn(
      ...
      <div className="container mx-auto flex justify-between items-center">
        <a href ="#" className="text-2xl font-bold text-shop-text hover:text-shop-blue-dark transition-colors">
          Шапка Шоп
        </a>
  ...
  className="text-lg font-semibold text-shop-text hover:text-shop-blue-dark transition-colors"
>
  Назад
</button>
        ...
        <button onClick={() => setIsCartOpen(true)} className="relative p-2">
            <ShoppingCart size={32} color="#33c4f0" />
            {cartItemCount > 0 && (
